						...
						<div class="form">
						 <input type="hidden" value="${user.getId()}" name="uid">
							<i class="fa-solid fa-user"></i> <input type="text" name="name"
								placeholder="First name & last name" value="${user.getUserName()}" required>
						</div>
					</td>
				</tr>
				<tr>
					<td>
						<div class="form">
							<i class="fa-solid fa-envelope"></i> <input type="email"
								name="email" placeholder="Enter email address" value="${user.getEmail()}" required>
						</div>
					</td>
				</tr>
				<tr>
					<td>
						<div class="form">
							<i class="fa-solid fa-lock"></i> <input type="text"
								name="password" id="pass" placeholder="Enter password" value="${user.getPassword()}"required>
						</div>
					</td>
				</tr>
					...
					<td>
						<div class="form">
							<i class="fa-solid fa-phone"></i> <input type="text"
								name="number" placeholder="Enter Mobile Number" value="${user.getNumber()}" required>
						</div>
					</td>
				</tr>
				<tr>
