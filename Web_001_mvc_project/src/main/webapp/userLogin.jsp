...
<body>
	...
	<div class="container">
		<div class="form-section">
			<form action="UserLogin" class="form">

				<h1 class="text-center bg-warning p-2 rounded mb-5">LOGIN HEAR</h1>

				<span style="color: red;">${Erorr}</span> <span style="color: green">${account}</span>
				...
				<div class="signup-section">
					<a href="userNewAccount.jsp">Create Account?</a> <a href="forget">forgot
						password?</a>
				</div>
			</form>
		</div>
