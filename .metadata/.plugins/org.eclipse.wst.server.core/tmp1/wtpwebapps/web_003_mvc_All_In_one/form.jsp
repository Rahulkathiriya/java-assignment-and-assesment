				...
				<form action="registration"
					...
					<div class="form-checked">
						<input type="radio" class="form-check-input" name="gender"
							id="gender"  value="male" checked="checked"/>
						&nbsp; Male <br /> <input type="radio" class="form-check-input"
					...
					<br> <label for="city" class="form-label">City</label> <select
						name="city" id="" class="form-select" value="${getData.getCity()}">
			...
			<div class="col col-md-7">
				...
				<table class="table table-striped table-dark">
					...
					<tr>
						...
						<td><%=reg.getGender()%></td>
						<td><%=reg.getCity()%></td>
						<td><a href="update?uid=<%=reg.getId()%>&&action=update"
							class="btn btn-primary">Update</a></td>
						<td><a href="update?uid=<%=reg.getId()%>&&action=delete"
