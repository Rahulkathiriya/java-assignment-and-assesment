 ...
 * Generated at: 2022-11-17 14:16:12 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("	\r\n");
      out.write("	$.get(\"addStudent\",{fname,lname,email,password,number,city},function(data){\r\n");
      out.write("		\r\n");
      out.write("		$(\"#student\").html(data);\r\n");
      out.write("		viewData();\r\n");
      out.write("	});\r\n");
      out.write("}\r\n");
      out.write("	\r\n");
      ...
      out.write("		\r\n");
      out.write("		$.get(\"viewData\",{},function(data){\r\n");
      out.write("			\r\n");
      out.write("			const info = JSON.parse(data);\r\n");
      out.write("			var row = \"\";\r\n");
      out.write("			row = row+\"<tr><th>ID</th><th>FNAME</th><th>LNAME</th><th>EMAIL</th><th>PASSWORD</th><th>NUMBER</th><th>CITY</th></tr>\"\r\n");
      out.write("			\r\n");
      out.write("			for(var i =0;i<info.length;i++){\r\n");
      out.write("				\r\n");
      out.write("				var student = info[i];\r\n");
      out.write("				row = row+\"<tr><td>\"+student.id+\"</td><td>\"+student.fname+\"</td><td>\"+student.lname+\"</td><td>\"+student.email+\"</td><td>\"+student.password+\"</td><td>\"+student.number+\"</td><td>\"+student.city+\"</td><td><button class='btn btn-danger bg-danger'onClick='deleteStudent(\"+student.id+\")'>Delete</button></td><td><button class='btn btn-primary bg-primary' onClick='dataById(\"+student.id+\")'>Update</button></td></tr>\";	\r\n");
      out.write("			}\r\n");
      out.write("			\r\n");
      out.write("			$(\"#table\").html(row);\r\n");
      out.write("			\r\n");
      out.write("			\r\n");
      out.write("		});\r\n");
      out.write("	\r\n");
      out.write("}\r\n");
      out.write("	\r\n");
      out.write("	function deleteStudent(uid)\r\n");
      out.write("	{\r\n");
      out.write("	$.get(\"update\",{uid},function(data){\r\n");
      out.write("		prompt(data);\r\n");
      out.write("		 viewData();\r\n");
      out.write("		\r\n");
      out.write("	});\r\n");
      out.write("	\r\n");
      ...
      out.write("	\r\n");
      out.write("	\r\n");
      out.write("	function dataById(uid){\r\n");
      out.write("		\r\n");
      out.write("		$.post(\"update\",{uid},function(data){\r\n");
      out.write("			\r\n");
      out.write("			var data = JSON.parse(data);\r\n");
      out.write("			\r\n");
      out.write("			$(\"#uid\").val(data.id);\r\n");
      out.write("			$(\"#fname\").val(data.fname);\r\n");
      out.write("			$(\"#lname\").val(data.lname);\r\n");
      out.write("			$(\"#email\").val(data.email);\r\n");
      out.write("			$(\"#password\").val(data.password);\r\n");
      out.write("			$(\"#number\").val(data.number);\r\n");
      ...
      out.write("		var city = $(\"#city\").val();\r\n");
      out.write("		\r\n");
      out.write("		$.post(\"addStudent\",{uid,fname,lname,email,password,number,city},function(data){\r\n");
      out.write("			$(\"#student\").html(data);\r\n");
      ...
      out.write("			<div class=\"col col-md-4 col-lg-4\">\r\n");
      out.write("				\r\n");
      out.write("					<div class=\"row\">\r\n");
      out.write("						<p class=\"h2 text-center bg-dark text-light p-2 pb-3 mt-2 rounded\">Registreation\r\n");
      out.write("							Form</p>\r\n");
      out.write("						<span class=\"text-success\" id=\"student\"></span> <span\r\n");
      ...
      out.write("							<input type=\"hidden\" name=\"uid\" id=\"uid\"> <label\r\n");
      out.write("								for=\"fname\" class=\"form-label\">Firstname :</label> <input\r\n");
      out.write("								type=\"text\" class=\"form-control\" name=\"fname\" id=\"fname\"\r\n");
      out.write("								placeholder=\"Enter First Name\" required=\"required\"> <span\r\n");
      out.write("								class=\"text-danger\">");
      ...
      out.write("								placeholder=\"Enter Last Name \" required /> <span\r\n");
      out.write("								class=\"text-danger\">");
      ...
      out.write("								placeholder=\"Enter Password\" required=\"required\"> <span\r\n");
      out.write("								class=\"text-danger\">");
      ...
      out.write("								placeholder=\"Enter mobile Number\" required=\"required\"> <span\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("					<br> <label for=\"lang\" class=\"form-label\">Languages :</label>\r\n");
      out.write("					<br> <input type=\"checkbox\" id=\"lang\" name=\"lang\"\r\n");
      out.write("						value=\"gujarati\">&nbsp;Gujarati &nbsp; <input\r\n");
      out.write("						type=\"checkbox\" id=\"lang\" name=\"lang\" value=\"hindi\">&nbsp;Hindi\r\n");
      out.write("					&nbsp; <input type=\"checkbox\" id=\"lang\" name=\"lang\" value=\"English\">&nbsp;English\r\n");
      out.write("					<br> <br> <label for=\"city\" class=\"form-label\">City</label>\r\n");
      out.write("					<select name=\"city\" id=\"city\" class=\"form-select\">\r\n");
      ...
      out.write("						<button class=\"btn btn-primary\" id=\"submit\" onclick=\"addStudent()\">Submit</button>\r\n");
      out.write("						<button class=\"btn btn-primary\" id=\"update\" onclick=\"updateStudent()\">Update</button>\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("			<div class=\"col col-md-8 col-lg-8 mx-auto\">\r\n");
      out.write("\r\n");
