		...
		<form action="addEmploye" method="post">
			<div class="row">
				<div class="col col-sm-12 col-md-6 col-lg-6">
					<input type="hidden" name="id" id="id" value="${allData.getId()}">
					<label class=" h4 form-label" for="fname">First Name :</label> <input
			...
			<div class="row">
				...
				<div class="col col-sm-12 col-md-6 col-lg-6">
					...
					<span class="text-danger">${numberError }</span> <span
						class="text-danger">${numberDightError }</span>
				</div>

				<div class="row mt-4">
					<div class="col col-sm-12 col-md-6 col-lg-6">
						<label class="form-label">Address : </label>
						<textarea rows="" cols="" class="form-control text-dark"
							name="address" id="address" value="${allData.getAddress() }"></textarea>
				...
				<div class="row mt-4">
					...
					<div class="col col-sm-12 col-md-6 col-lg-6">
						<label class=" h4 form-label" for="conpass">Confirm
							...
							class="form-control" placeholder="Enter confirm password" value="${allData.getPassword()}">
				...
				<div class="row mt-5 mb-4">
					...
					<div class="col col-sm-12 col-md-6 col-lg-6 text-start">
				   <a href="viewEmployee">ViewEmployee</a>
				 </div>
				</div>
		</form>
